...
public class View {
    ...
    private Map<String, Printable> generateEventMenuMethods() {
        ...
        Formatter<Event, Integer> formatter = new Formatter<>(Event.class);
        ViewOperations<Event, Integer> eventOperation = new ViewOperations<>(eventController, formatter, Event.class);
    ...
    private Map<String, Printable> generateTypeOfDeliveryMenuMethods() {
        ...
        Formatter<TypeOfDelivery, Integer> formatter = new Formatter<>(TypeOfDelivery.class);
        ViewOperations<TypeOfDelivery, Integer> typeOfDeliveryOperation = new ViewOperations<>(typeOfDeliveryController, formatter, TypeOfDelivery.class);
    ...
    private Map<String, Printable> generateTypeOfEventMenuMethods() {
        ...
        Formatter<TypeOfEvent, Integer> formatter = new Formatter<>(TypeOfEvent.class);
        ViewOperations<TypeOfEvent, Integer> typeOfEventOperation = new ViewOperations<>(typeOfEventController, formatter, TypeOfEvent.class);
    ...
    private Map<String, Printable> generateTicketMenuMethods() {
        ...
        Formatter<Ticket, String> formatter = new Formatter<>(Ticket.class);
        ViewOperations<Ticket, String> ticketOperation = new ViewOperations<>(ticketController, formatter, Ticket.class);
    ...
    private Map<String, Printable> generateArtistOrGroupMenuMethods() {
        ...
        Formatter<ArtistOrGroup, Integer> formatter = new Formatter<>(ArtistOrGroup.class);
        ViewOperations<ArtistOrGroup, Integer> artistOrGroupOperation = new ViewOperations<>(artistOrGroupController, formatter, ArtistOrGroup.class);
